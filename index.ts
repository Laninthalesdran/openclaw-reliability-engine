...
export default definePluginEntry({
  ...
  description:
    "Scores how much a claim should move your beliefs — by evidence and persuasion " +
  ...
  register(api) {
    ...
    api.registerTool({
      ...
      description:
        "Score a claim's reliability (0-10) from its evidence: provenance, verifiability, " +
      ...
      async execute(_id, params) {
        const r = engine.scoreClaim(params as any);
    ...
    api.registerTool({
      ...
      description:
        "Look up a source's reliability profile: validity (accuracy earned from outcomes), bias " +
    ...
    api.registerTool({
      ...
      description:
        "Scan text for persuasion TECHNIQUE (loaded language, fear appeals, weasel attribution, " +
    ...
    api.registerTool({
      ...
      description:
        "Rate a source's STRUCTURAL bias magnitude (0-1) from a batch of its own claims/headlines, " +
